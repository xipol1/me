...
const AdvertiserDashboard = () => {
  ...
  const recentActivities = [
    { 
      content: 'Anuncio aprobado en Canal Tecnología', 
    ...
    { 
      content: 'Anuncio rechazado en Canal Moda', 
      timestamp: 'Hace 1 día',
      icon: <svg className="w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
    },
    { 
      content: 'Pago realizado: $120.00', 
      timestamp: 'Hace 2 días',
      icon: <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
    },
  ];
  
  // Datos de ejemplo para anuncios activos
  const activeAds = [
    {
      id: '12345',
  ...
  const recommendedChannels = [
    {
      name: 'Canal Tecnología Premium',
      platform: 'Telegram',
      audience: '50K seguidores',
      price: '$85.00',
      category: 'Tecnología',
      rating: 4.8
    },
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard
          ...
          icon={<svg className="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" /></svg>}
          trend="up"
          trendValue="2 nuevos esta semana"
        />
        <StatCard
          title="Canales Usados"
          value="5"
          icon={<svg className="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg>}
          trend="up"
          trendValue="1 nuevo este mes"
        />
        <StatCard
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-card p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-medium text-gray-900">Anuncios Activos</h2>
          ...
          <div className="bg-white rounded-xl shadow-card p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-6">Rendimiento de Anuncios</h2>
            
            <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
              <p className="text-gray-500">Gráfico de rendimiento de anuncios</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-card p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-medium text-gray-900">Canales Recomendados</h2>
              ...
              {recommendedChannels.map((channel, index) => (
                <div key={index} className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="mt-2 flex justify-between text-sm">
                    <span className="text-gray-600">{channel.audience}</span>
                    <span className="font-medium text-primary-600">{channel.price}</span>
                  </div>
                  <div className="mt-2 flex justify-between text-sm">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-1">{channel.rating}/5</span>
                    </div>
                  </div>
                  <div className="mt-3">
...
export default withAuth(AdvertiserDashboard, ['advertiser', 'admin']); // Wrap with withAuth
